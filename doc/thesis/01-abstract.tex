...
One tool to examine a graph's structure is traversal-based algorithms.
...
Relational databases have been optimized for decades, while graph databases are relatively new research in this respect.
...
The graph's structure governs the sequence in which traversal algorithms inspect records.
...
We present a survey of state-of-the-art graph record rearrangement strategies, along with the proposition of an improvement to such methods on a particular record structure.
